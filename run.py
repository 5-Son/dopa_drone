...
from dopa.problem import DynamicUAVTargetAssignmentProblem, UAVTargetAssignmentProblem
from dopa.scenarios import run_scenario
from dopa.utils import set_seed
...
def make_problem(cfg: Dict, seed: int):
    """
    Create a (static or dynamic) problem instance with deterministic RNG based on seed.
    """
    set_seed(seed)
    ...
    max_total_missions = cfg.get("max_total_missions", 20)
    ...
    # pass scheme/device through the problem so run_scenario can pick it up without API changes
